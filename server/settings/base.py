...
TEMPLATES = [
    {
        ...
        'DIRS': [Path(BASE_DIR).resolve().parent / 'server' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
logging.info('DATABASES: %s'%str(DATABASES['default']))

# Auth

AUTHENTICATION_BACKENDS = [
    'django.contrib.auth.backends.ModelBackend' # Authentication using the database
]
